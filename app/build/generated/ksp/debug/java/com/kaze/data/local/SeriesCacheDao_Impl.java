  ...
  public SeriesCacheDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSeriesCache = new EntityInsertionAdapter<SeriesCache>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `series_cache` (`imdbId`,`title`,`totalSeasons`,`isFinished`,`cachedAt`) VALUES (?,?,?,?,?)";
      }
      ...
      public SeriesCache call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new SeriesCache(_tmpImdbId,_tmpTitle,_tmpTotalSeasons,_tmpIsFinished,_tmpCachedAt);
          } else {
            _result = null;
          }
          return _result;
